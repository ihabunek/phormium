...
class Query
{
    ...
    public function __construct(Meta $meta, Database $database)
    {
        $this->database = $database;
        $this->meta = $meta;

        $config = $database->getConnectionConfig($meta->database);

        $this->driver = $this->getDriver($config['dsn']);
    }
    ...
    public function insert(Model $model)
    {
        ...
        $conn = $this->database->getConnection($meta->database);
